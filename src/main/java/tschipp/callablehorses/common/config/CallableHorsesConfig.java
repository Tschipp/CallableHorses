...
import tschipp.callablehorses.common.helper.ReflectionUtil;


@Config(modid = CallableHorses.MODID)
public class CallableHorsesConfig
{

	@Config.LangKey(CallableHorses.MODID)
	...
	public static class EventHandler
	{
		...
		public static Configuration getConfiguration()
		{
			if (EventHandler.configuration == null)
				try
				{
					final String fileName = CallableHorses.MODID + ".cfg";
		...
		{
			if (event.getModID().equals(CallableHorses.MODID))
				ConfigManager.load(CallableHorses.MODID, Config.Type.INSTANCE);
